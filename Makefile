...
#
TOP = /home/gudrhks2/sqlite-src-3140100
...
#
CC = gcc
CFLAGS =   -g -O0 -DSQLITE_OS_UNIX=1 -DSQLITE_ENABLE_IOTRACE=1 -DSQLITE_FORCE_OS_TRACE=1 -DSQLITE_DEBUG=1 -DSQLITE_DEBUG_OS_TRACE=1
